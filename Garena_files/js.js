    ...
    resource: {
      ...
      tags: [
        ...
        },
        {
          ...
          priority: 12,
          vtp_instanceDestinationId: "G-BEF8MFGW66",
          tag_id: 18,
        },
        {
...
*/
  ...
  Ki.ob = "dataLayer";
  Ki.Dn =
    "ChEIgLqLugYQp4zo/d34waPlARIlAE53BYhiZEO3JHmv/nMpgerbPhClSNFYBCehf66xBiilPoyHThoCpD4\x3d";
  var Mi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  var gk = {},
    ...
    Qf = {
      ctid: "G-BEF8MFGW66",
      canonicalContainerId: "172511120",
      tk: "G-BEF8MFGW66|GT-NSLHRTP",
      uk: "G-BEF8MFGW66",
    };
  gk.ze = mb("");
  function ik() {
  ...
  try {
    pl = JSON.parse(
      Ta(
        "eyIwIjoiSU4iLCIxIjoiSU4tS0wiLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5jby5pbiIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"
      )
    );
  } catch (a) {
    V(123), ol(2), (pl = {});
  ...
  function GF() {
    ...
    L(this, "read_container_data"),
      R(45) && FF
        ? (a = FF)
        : (a.set("containerId", "G-BEF8MFGW66"),
          a.set("version", "1"),
